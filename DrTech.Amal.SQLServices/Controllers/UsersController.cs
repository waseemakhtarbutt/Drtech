                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        foreach (var user in UserList)
                        {
                            ...
                            foreach (MMrClean item in recycle)
                            {
                                ...
                                sqlRecycle.RecycleSubItems.Add(sqlrecitems);
                            ...
                            sqlUser.Refuses = sqlRefuseList;
                            sqlUser.Reduces = sqlReduceList;
                            sqlUser.Reuses = sqlReuseList;
                            sqlUser.Replants = sqlReplantList;
                            sqlUser.BuyBins = sqlBuyBinList;
                            sqlUser.Recycles = sqlrecycleList;
                            sqlUser.Regifts = sqlRegiftList;
                            sqlUser.Reports = sqlReportList;
